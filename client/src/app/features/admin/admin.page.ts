...
@Component({ imports: [AsyncPipe, ReactiveFormsModule], templateUrl: './admin.page.html', styleUrl: './admin.page.scss', changeDetection: ChangeDetectionStrategy.OnPush })
export class AdminPage {
  ...
  createUser(): void { if (this.userForm.invalid) return; this.api.registerUser(this.userForm.getRawValue()).subscribe(() => { this.toast.show('User account created.', 'success'); this.userForm.reset({ name: '', email: '', password: '', role: 'REQUESTER' }); }); }
